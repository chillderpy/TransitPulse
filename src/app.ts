...
export function createApp() {
  ...
  app.use(
    helmet({
      // The dev UI renders an OpenStreetMap (Leaflet) map: tiles load as
      // <img> from OSM's tile servers, everything else (Leaflet's own
      // JS/CSS/marker icons, app.js/style.css) is self-hosted under
      // public/ so 'self' still covers it.
